...
c
      ...
      if (ifstdh) then
         ...
         if (name.eq.'PRES') call printmax_nt(r,n,'r nmax a')
         call project1
     $       (r,n,approx,napprox,h1,h2,vmk,vml,ifwt,ifvec,name6)
         if (name.eq.'PRES') call printmax_nt(r,n,'r nmax b')
         call hmhzpf (name,u,r,h1,h2,vmk,vml,imsh,tol,maxit,isd,bi)
         if (istep.gt.100) then
         if (name.eq.'PRES') then
          call sub3(dru,rcopy,u,n)
          call sub3(dru2,r,u,n)
          call outpost(r,rcopy,r,u,r,'   ')
         endif 
         endif 
