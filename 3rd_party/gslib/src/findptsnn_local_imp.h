...
#define hash_data           TOKEN_PASTE(findptsnn_local_hash_data_,D)
...
#define findptsnn_el_data     TOKEN_PASTE(findptsnn_el_data_   ,D)
#define findptsnn_el_pt       TOKEN_PASTE(findptsnn_el_pt_     ,D)
#define findptsnn_el_setup    TOKEN_PASTE(PREFIXED_NAME(findptsnn_el_setup_),D)
#define findptsnn_el_free     TOKEN_PASTE(PREFIXED_NAME(findptsnn_el_free_ ),D)
#define findptsnn_el          TOKEN_PASTE(PREFIXED_NAME(findptsnn_el_      ),D)
#define findptsnn_el_eval     TOKEN_PASTE(PREFIXED_NAME(findptsnn_el_eval_ ),D)
#define findptsnn_el_start    TOKEN_PASTE(findptsnn_el_start_  ,D)
#define findptsnn_el_points   TOKEN_PASTE(findptsnn_el_points_ ,D)
...
static void map_points_to_els(
  ...
  const uint npt, const struct findptsnn_local_data *const fd,
  buffer *buf)
{
  uint index;
  ...
  buffer *buf)
{
  ...
  struct findptsnn_el_pt *const fpt = findptsnn_el_points(fed);
...
//        *dist2 = sqrt(*dist2)/maxobb<1.e-6 ? 0.0 : *dist2;
          if (sqrt(*dist2)/maxobb<1.e-6 && *code==CODE_BORDER) {
              *code = CODE_EXACT_BORDER; 
              }
//          *code = (sqrt(*dist2)/maxobb>1.e-8 && *code==CODE_BORDER) ? CODE_NOT_EXACT_BORDER :  CODE_BORDER;
...
#undef findptsnn_el_points
#undef findptsnn_el_start
#undef findptsnn_el_eval
#undef findptsnn_el
#undef findptsnn_el_free
#undef findptsnn_el_setup
#undef findptsnn_el_data
#undef hash_free
#undef hash_build
#undef hash_bb
#undef hash_opt_size
